...
const FONT_ALIASES = new Map<string, string>([
  ...
  ["work sans", "Work Sans"],
  // —— из theme_settings (с начертанием в имени); база + редкости ——
  ["zen kaku gothic new", "Zen Kaku Gothic New"],
  ["zen kaku gothic new light", "Zen Kaku Gothic New"],
  ["zen kaku gothic new regular", "Zen Kaku Gothic New"],
  ["cormorant", "Cormorant"],
  ["cormorant light", "Cormorant"],
  ...
  ["roboto flex light", "Roboto Flex"],
  ["squada one", "Squada One"],
  ["staatliches", "Staatliches"],
  ["strike vortex", "Oswald"],
  ["exo", "Exo"],
  ...
  ["space grotesk regular", "Space Grotesk"],
  ["open sans light", "Open Sans"],
  ["open sans regular", "Open Sans"],
  ["open sans light italic", "Open Sans"],
  ["lato light", "Lato"],
  ["montserrat light", "Montserrat"],
  ["oswald light", "Oswald"],
  ["oswald bold", "Oswald"],
  ["raleway thin", "Raleway"],
  ["playfair display light", "Playfair Display"],
  ["source sans pro light", "Source Sans 3"],
  // Брендовые/не GF → ближайший аналог
  ["antique olive", "Lato"],
  ["bad russian", "PT Sans"],
  ["battlemage", "Cinzel"],
  ["battleworn", "Oswald"],
  ["belico", "Roboto"],
  ["coder", "IBM Plex Mono"],
  ["collector comic", "Bangers"],
  ["ep stellari", "Orbitron"],
  ["kosmos", "Space Grotesk"],
  ["kragdent", "Oswald"],
  ["kudryashev", "PT Sans"],
  ["maswen", "Inter"],
  ["modernist", "Inter"],
  ["newro space", "Orbitron"],
  ["rodchenko", "Oswald"],
  ["st artefakt", "Inter"],
  ["sogtric", "Space Grotesk"],
  ["soyuz grotesk", "Manrope"],
  ["space", "Space Grotesk"],
  ["stifly", "Oswald"],
  ["knight warrior", "Orbitron"],
  ["planeto", "Orbitron"],
]);
